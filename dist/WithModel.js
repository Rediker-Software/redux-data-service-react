...
function withModel(dataServiceName, idPropKey, modelPropKey) {
    ...
    return recompose_1.branch(function (props) { return props[modelPropKey] == null && props[idPropKey] != null; }, recompose_1.mapPropsStreamWithConfig(rxjsObservableConfig_1.default)(function (props$) {
        return props$.combineLatest(props$.switchMap(function (props) { return redux_data_service_1.getDataService(dataServiceName).getById(props[idPropKey]); }), function (props, model) {
            var _a;
